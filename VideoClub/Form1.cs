...
namespace VideoClub
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            return "server=localhost\\SQLEXPRESS ; database=Ejercicio3 ; integrated security = true";
        }
        ...
        private void devolverToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                /*
                 * Aqui pondremos el mensaje que el sistema da, si llegamos al numero maximo 5 copias
                 * de cada pelicula 
                 */
